        ...
        Column(
            ...
            CenterAlignedTopAppBar(
                ...
                colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                    ...
                    navigationIconContentColor = AppThemeState.textColor,
                ...
                Row(
                    ...
                    Button(
                        ...
                        colors = ButtonDefaults.buttonColors(
                            containerColor = if (!showDemo) {
                                if (AppThemeState.darkMode) Color(0xFF555555) else Color(0xFF005BBB)
                            } else {
                                if (AppThemeState.darkMode) Color(0xFF2F2F2F) else Color.White.copy(alpha = 0.85f)
                            }
                        )
                    ) {
                        Text(
                            text = "Current User",
                            color = if (!showDemo) Color.White else AppThemeState.textColor
                        )
                    }
...
private fun EmptyLearningChart(headline: String, subtext: String) {
    val chartBg = if (AppThemeState.darkMode) Color(0xFF3A3A3A) else Color(0xFFF4F6F8)
...
private fun SevenDayTrendChart(points: List<DailyTrendPoint>) {
    ...
    val chartBg = if (AppThemeState.darkMode) Color(0xFF3A3A3A) else Color(0xFFF4F6F8)
    val axisColor = if (AppThemeState.darkMode) Color.LightGray else Color.Gray
    val gridColor = if (AppThemeState.darkMode) Color.Gray.copy(alpha = 0.45f) else Color.LightGray.copy(alpha = 0.65f)
